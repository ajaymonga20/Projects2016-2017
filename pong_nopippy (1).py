...
# December 20, 2016
# Ajay Monga - Initial Code From Pippy Activity 
...
# start the screen green 
# Screen is just a variable declared earlier... 
bgcolor = (0, 255, 0)
screen.fill(bgcolor)
...
step = 12  # paddle moves 6 pixels at a go
...
msg = "click on Joel Ward to start game"
# create a font of a specified sizw
font = pygame.font.Font(None, fsize)
# Render the font in a certain colour 
...
# We must use python3 to use a png file
# Changes the image to the file 'joelward.png' stored in the same folder as pong
asurf = pygame.image.load('joelward.png') 
...
# HOEL - keep score
# str() is a function to type cast to a string 
score = 0
...
# HOEL - make a sound
pygame.mixer.music.load("hit.wav") # sound


#while pippy.pygame.next_frame(): - HOEL
# GAME LOOP INFINITE UNTIL CLICK EXITS
while True:

    # display msg
    screen.fill(bgcolor)
	# blit is drawing to a buffer 
    ...
    for idle_event in pygame.event.get():
        ...
        #    if idle_event.key == 103:  # g key
                ...
                while balls > 0:
                    ...
                    # Task 1 is change speed of ball, starts at (3, 5) (3, 5) 
                    ball_mvect = [randint(8, 11), randint(8, 11)] # Ball Speed
                    ball_limit = size
                    balls = balls - 1
                    ...
                    while ball_position[0] + ball_radius < ball_limit[0]:  # in play
                        ...
                        screen.blit(scoretext,scoreRect)
								...
								# How I tried to make a random color appear when the ball hit the paddle
